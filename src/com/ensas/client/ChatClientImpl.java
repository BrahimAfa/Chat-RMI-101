...
public class ChatClientImpl extends UnicastRemoteObject implements IChatClient {
	...
	private String serviceName = "EnsasNetwork";
	private String clientServiceName;
	private String name;
	protected IChatServer serverIF;
	protected boolean connectionProblem = false;

	public ChatClientImpl(ClientUI aChatGUI, String userName) throws RemoteException {
		super();
	...
	public void startClient() throws RemoteException {		
		...
		try {
			...
			serverIF = (IChatServer)Naming.lookup("rmi://" + hostName + "/" + serviceName);
